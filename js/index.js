...
function ChangeGharardad() {
  var name = document.getElementById("SelectGharadad").value;
  if(name == "اجاره"){
    $("#SellPrice").addClass("DisNone");
    $("#RentPrice").removeClass("DisNone");
  }
  else{
    $("#SellPrice").removeClass("DisNone");
    $("#RentPrice").addClass("DisNone");
  }
}
ChangeGharardad()
